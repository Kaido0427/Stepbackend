@extends('layouts.app', ['title' => __('Concierge de Parking')],['activePage' => 'parkingOwner'])
                ...
                <div class="card-body shop-detail">
                    <div class="row">
                        ...
                        <div class="col-12 row shop-data">
                            ...
                            <div class="col-3 pl-4">
                                ...
                                <p><span class="badge badge-pill badge-{{$data->status == 0 ? 'warning' : 'success'}}">
                                        {{$data->status == 1 ? 'Activé':'DésActivéd'}}
                                    </span> </p>
                            </div>
                        </div>
                        <div class="col-12">
                        ...
                        <div class="col-12 shop-bottom">
                            <h3 class="mt-4"> {{__('Installations')}}</h3>
                            <div class="row">
