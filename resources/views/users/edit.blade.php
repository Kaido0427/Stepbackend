@extends('layouts.app', ['title' => __('Gestion des clients')],['activePage' => 'Clients'])

@section('content')
    @include('layouts.headers.header', ['title' => __('Editer L'Client')])   
                        ...
                        <form method="post" action="{{ route('user.update', $user) }}" autocomplete="off">
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="form-group{{ $errors->has('password') ? ' has-danger' : '' }}">
                                    <label class="form-control-label" for="password">{{ __('Mot de passe') }}</label>
                                ...
                                <div class="form-group">
                                    <label class="form-control-label" for="password-confirmation">{{ __('Confirmer le mot de passe') }}</label>
