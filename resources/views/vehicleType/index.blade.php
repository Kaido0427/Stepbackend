...
array(
'class'=>'info',
'title'=>"Type de Vélo",'description'=>'',
'icon'=>'fas fa-home',
'breadcrumb'=>array([
'text'=>'Type de Vélo'
])))
                ...
                <div class="card-header border-0">
                    <div class="row align-items-center">
                        <div class="col-12 text-right">
                            <a href="{{ route('vehicle_type.create') }}" class="btn btn-sm btn-primary">{{ __('Ajouter un type de vélo') }}</a>
                        </div>
                    </div>
                </div>
                                ...
                                <td class="text-right">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                            ...
                                            <a class="dropdown-item" href="{{ route('vehicle_type.edit',$item) }}">{{ __('Editer') }}</a>
