                ...
                <div class="card-header border-0">
                    <div class="row align-items-center">
                        <div class="col-12 text-right">
                            <a href="{{route('faq.create')}}" class="btn btn-sm btn-primary">{{ __('Ajouter FAQ') }}</a>
                        </div>
                    </div>
                </div>
                                ...
                                <td class="text-right">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                            ...
                                            <a class="dropdown-item rtl_edit" href="{{ route('faq.edit',$item) }}">{{ __('Editer') }}</a>
                                        </div>
                                    </div>
                                </td>
                            </tr>
